...
class ConfigShellTest(SaltMockTestCase):
    ...
    def test_system_upgrade_packages(self):
        self.assertFlagOption('/System_Upgrade/Packages',
                              'ceph-salt:upgrades:enabled')

    def test_system_upgrade_reboot(self):
        self.assertFlagOption('/System_Upgrade/Reboot',
                              'ceph-salt:upgrades:reboot')
